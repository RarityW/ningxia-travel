...
func main() {
	...
	// 创建测试用户
	userSQL := `INSERT INTO users (open_id, nick_name, avatar, gender, is_active, created_at, updated_at) VALUES ('test_user_simple', '测试用户', '/images/avatar.jpg', 1, 1, NOW(), NOW()) ON DUPLICATE KEY UPDATE nick_name='测试用户'`
